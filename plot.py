...
data = pd.read_csv('results_pronunciation_onfixtest.csv')
...
plt.tight_layout()
plt.savefig('confusion_matrix_newloss_test_fixtestset.png')
plt.close()
...
with open("results_test_fixset_newloss.log", "a", encoding="utf-8") as log_file:
    log_file.write(log_content)

print("Kết quả đã được lưu vào file 'results.log' và hình Confusion Matrix thành 'confusion_matrix_augment.png'.")
